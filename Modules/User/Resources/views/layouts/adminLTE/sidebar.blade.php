  ...
  <aside class="sidebar-nav-wrapper style-2">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        @endcan
        @can('sales-list')
        <li class="nav-item {{ (request()->is('user/sales')) || (request()->is('user/sales/*')) ? 'active' : '' }}">
        ...
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_1" class="dropdown-nav" style="{{ (request()->is('user/reports/*')) || (request()->is('user/whatdo/*')) ? '' : 'display:none' }}">
            ...
            <li>
              <a href="{{ url('/user/reports/sales') }}" class="{{ (request()->is('/user/reports/sales')) ? 'active' : '' }}">Resumen Ventas</a>
            </li>
            <li>
