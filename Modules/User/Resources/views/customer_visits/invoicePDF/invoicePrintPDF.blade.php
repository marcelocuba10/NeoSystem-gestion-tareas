...
<div class="head-title">
    <h1 class="text-center m-0 p-0">{{ $customer_visit->type }}</h1>
</div>
<div class="add-detail mt-10">
    <div class="w-50 float-left mt-10">
        <p class="m-0 pt-5 text-bold w-100">Invoice Id - <span class="gray-color">#{{ $customer_visit->visit_number }}</span></p>
    ...
    <div class="w-50 float-left logo mt-10">
        <img src="http://127.0.0.1:8000/public/adminLTE/images/logo/logo-pyp.png"> <span>Nicesnippets.com</span>     
    </div>
