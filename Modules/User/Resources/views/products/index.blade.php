        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              ...
              @can('products-create')
                <a href="/user/products/create" class="main-btn info-btn btn-hover btn-sm"><i class="lni lni-plus mr-5"></i></a>
              @endcan  
            </div>
          </div>
          <!-- end col -->
                  ...
                  <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="min-width"><p>{{ $product->sale_price }}</p></td>
                            <td class="min-width"><p>{{ $product->quantity }}</p></td>
                            <td class="text-right">
                                <div class="btn-group">
                                    <div class="action">
                                    ...
                                    @can('products-edit')
                                    <div class="action">
                                        <a href="/user/products/edit/{{$product->id}}">
                                          <button class="text-info"><i class="lni lni-pencil"></i></button>
                                        </a>
                                    </div>
                                    @endcan
                                    @can('products-delete')
                                    <form method="POST" action="/user/products/delete/{{$product->id}}">
                                        @csrf
                                        <div class="action">
