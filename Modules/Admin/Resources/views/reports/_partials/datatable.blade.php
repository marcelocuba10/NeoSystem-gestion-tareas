              ...
              <div class="btn-group">
                <div class="action">
                  @if ($customer_visit->type == 'Presupuesto')
                    <a href="{{ url('/admin/customer_visits/generateInvoicePDF/?download=pdf&customer_visit='.$customer_visit->id) }}" data-toggle="tooltip" data-placement="bottom" title="Imprimir" target="_blank">
