        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              ...
              <a href="{{ url('/admin/reports/products?download=pdf') }}" class="btn btn-lg success-btn rounded-md btn-hover" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Imprimir Relatorio de Productos"><i class="lni lni-printer"></i></a>
            </div>
          </div>
        </div>
      </div>
