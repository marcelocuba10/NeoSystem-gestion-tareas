          ...
          <div class="breadcrumb-wrapper mb-30">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/admin/reports/sales') }}">Ventas</a></li>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="button-group d-flex justify-content-center flex-wrap">
                  <a class="main-btn primary-btn-outline m-2" href="{{ url('/admin/reports/sales') }}">Atrás</a>
                </div>
              </div>
