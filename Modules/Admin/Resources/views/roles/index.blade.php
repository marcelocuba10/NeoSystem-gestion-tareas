        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              ...
              @can('role-sa-create')
              <a href="{{ url('/admin/ACL/roles/create') }}" class="main-btn info-btn btn-hover btn-sm"><i class="lni lni-plus mr-5"></i></a>
              @endcan  
            </div>
          </div>
          <div class="col-md-4">
            <div class="right">
              <div class="table-search d-flex" style="margin-top: -35px;float: right;">
                <form action="{{ url('/admin/ACL/roles/search') }}">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                          <div class="btn-group">
                            <div class="action">
                              <a href="{{ url('/admin/ACL/roles/show/'.$role->id) }}">
                            ...
                            @can('role-sa-edit')
                            <div class="action">
                              <a href="{{ url('/admin/ACL/roles/edit/'.$role->id) }}">
