...
use Modules\Admin\Entities\CustomerVisit;
use Modules\Admin\Entities\OrderDetail;
use Modules\Admin\Entities\Sales;
...
class CustomerVisitController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::customer_visits.index', compact('customer_visits'))->with('i', (request()->input('page', 1) - 1) * 20);
    }
    ...
    public function create()
    {
        ...
        return view('admin::customer_visits.create', compact('customers', 'customer_visit', 'currentDate', 'actions', 'products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('/admin/customer_visits')->with('message', 'Visita Cliente Creada Correctamente');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin::customer_visits.edit', compact('customers', 'customer_visit', 'currentDate', 'actions', 'products', 'order_details', 'total_order'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->to('/admin/customer_visits')->with('message', 'Visita Cliente actualizada correctamente.');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('admin::customer_visits.index', compact('customer_visits', 'search'))->with('i', (request()->input('page', 1) - 1) * 20);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->to('/admin/customer_visits')->with('message', 'Visita cliente cancelado correctamente');
    }
}
